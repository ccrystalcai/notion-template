...
/* ============================================
   问题反馈组件（内联）
   ============================================ */
function FeedbackSection({ templateId, sessionToken }: { templateId: string; sessionToken: string | null }) {
      ...
      {!open ? (
        ...
        <div className="space-y-3">
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 rounded-xl bg-cosmic/30 border border-lavender/20 text-sm text-silver placeholder:text-silver/20 focus:outline-none focus:border-lavender/50 resize-none transition-colors"
          />
